<template>
    <div class="flex flex-col w-full items-center justify-center space-y-5">
        <h2 class="text-4xl font-bold">Ani 有什么亮点</h2>
        <div class="grid grid-cols-1 md:grid-cols-2 w-full xl:w-3/5">
