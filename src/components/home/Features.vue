  ...
  <div class="flex flex-col w-full items-center justify-center space-y-5">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 w-full md:w-3/5">
      ...
      <FeatureCard title="使用 bangumi 管理追番进度">
        ...
        <template #default>
          <svg
            class="h-6 w-6 text-white" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
            viewBox="0 0 24 24"
          >
            <g fill="none">
              <path
              ...
              />
              <path stroke="currentColor" stroke-linecap="round" stroke-width="1.5" d="m9 2l3 3.5L15 2" opacity="0.5" />
              <path stroke="currentColor" stroke-linecap="round" stroke-width="1.5" d="M16 6v16" />
              <path
                fill="currentColor" d="M20 16a1 1 0 1 0-2 0a1 1 0 0 0 2 0m0-4a1 1 0 1 0-2 0a1 1 0 0 0 2 0"
                opacity="0.5"
              />
            </g>
          </svg>
      ...
      <FeatureCard title="代码开源">
        <template #desc>
          开放源代码, 公开自动构建, 无资料泄露风险，可 PR 添加自己喜欢的功能。
        </template>
        <template #default>
          <svg
            class="h-6 w-6 text-white" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
